...
export function PerspectivasStats({ kpis, objetivos, iniciativas, perspectivas }: PerspectivasStatsProps) {
  ...
  const getPerspectivaVisuals = (nombre: string, id: number) => {
    ...
    // Fallback
    const colors = [
      { color: "text-gray-600", bgColor: "bg-gray-500", lightBg: "bg-gray-50", borderColor: "border-gray-200", emoji: "🏢" },
      { color: "text-red-600", bgColor: "bg-red-500", lightBg: "bg-red-50", borderColor: "border-red-200", emoji: "🔴" },
      { color: "text-pink-600", bgColor: "bg-pink-500", lightBg: "bg-pink-50", borderColor: "border-pink-200", emoji: "🌸" },
      { color: "text-cyan-600", bgColor: "bg-cyan-500", lightBg: "bg-cyan-50", borderColor: "border-cyan-200", emoji: "🔵" },
    ]
  ...
  // Mapeo de perspectiva por nombre
  const mapPerspectiveName = (perspective: string): number => {
    ...
    // Fallback para nombres estándar
  ...
  // Calcular estadísticas por perspectiva
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600">Datos reales de la base de datos por perspectiva estratégica</p>
      </div>
            ...
            <div key={perspectiva.id} className={`${perspectiva.lightBg} ${perspectiva.borderColor} border rounded-lg p-4 hover:shadow-md transition-shadow`}>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  <div className={`p-2 ${perspectiva.bgColor} rounded-lg mr-3 text-white text-xl`}>
                    {perspectiva.emoji}
                  </div>
                  <div>
              ...
              <div className="mt-2 text-center">
                {perspectiva.total === 0 ? (
                  <span className="text-xs text-red-600 bg-red-100 px-2 py-1 rounded">Sin datos</span>
                ) : perspectiva.total < 3 ? (
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        <h4 className="font-medium text-gray-800 mb-3">📊 Análisis BSC</h4>
        ...
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded">
          <p className="text-blue-800 text-sm">
            ...
            {backendStats.perspectivasActivas === perspectivasConfig.length 
              ? " ¡Excelente! Tienes datos en todas las perspectivas del BSC."
              ...
              : " Tu BSC necesita más balance. Agrega datos en más perspectivas."}
          </p>
        </div>
